with ssr as
         (select s_store_id,
          ...
          from (select ss_store_sk              as store_sk,
                ...
                from cassandra.c_bigdata.store_returns) salesreturns,
               postgres.p.date_dim,
               redis.r.store
          where date_sk = d_date_sk
            and d_date between cast('2000-08-23' as date)
              and date_add('day', 14, cast('2000-08-23' as date))
     ...
     csr as
         (select cp_catalog_page_id,
          ...
          from (select cs_catalog_page_sk       as page_sk,
                ...
                from cassandra.c_bigdata.catalog_returns) salesreturns,
               postgres.p.date_dim,
               cassandra.c_bigdata.catalog_page
          where date_sk = d_date_sk
            and d_date between cast('2000-08-23' as date)
              and date_add('day', 14, cast('2000-08-23' as date))
     ...
     wsr as
         (select web_site_id,
          ...
          from (select ws_web_site_sk           as wsr_web_site_sk,
                ...
                from cassandra.c_bigdata.web_returns
                         left outer join cassandra.c_bigdata.web_sales on
